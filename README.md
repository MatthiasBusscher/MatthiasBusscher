...
- Privacy-first processing without scan history
- Optional accounts, API keys, and self-hosting
- Built with Next.js, TypeScript, Supabase, Docker, and Cloudflare

[Try Maillume](https://app.maillume.io) · [Visit website](https://maillume.io)
